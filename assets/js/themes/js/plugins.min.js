...
!(function (factory) {
  ...
  hljs.registerLanguage("php", function (e) {
    var c = { b: "\\$+[a-zA-Z_-Ã¿][a-zA-Z0-9_-Ã¿]*" },
      a = { cN: "meta", b: /<\?(php)?|\?>/ },
      i = {
        cN: "string",
        c: [e.BE, a],
  ...
  (function ($, window, document) {
    ...
    var $pswp = $(
        '<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true"><div class="pswp__bg"></div><div class="pswp__scroll-wrap"><div class="pswp__container"><div class="pswp__item"></div><div class="pswp__item"></div><div class="pswp__item"></div></div><div class="pswp__ui pswp__ui--hidden"><div class="pswp__top-bar"><div class="pswp__counter"></div><button class="pswp__button pswp__button--close" title="' +
          (photoswipe_l10n.close || "Close (Esc)") +
          '"></button><button class="pswp__button pswp__button--share" title="' +
          (photoswipe_l10n.share || "Share") +
          '"></button><button class="pswp__button pswp__button--fs" title="' +
          (photoswipe_l10n.fullscreen || "Toggle fullscreen") +
          '"></button><button class="pswp__button pswp__button--zoom" title="' +
          (photoswipe_l10n.zoom || "Zoom in/out") +
          '"></button><div class="pswp__preloader"><div class="pswp__preloader__icn"><div class="pswp__preloader__cut"><div class="pswp__preloader__donut"></div></div></div></div></div><div class="pswp__share-modal pswp__share-modal--hidden pswp__single-tap"><div class="pswp__share-tooltip"></div> </div><button class="pswp__button pswp__button--arrow--left" title="' +
        ...
        if (
          ...
          for (var i = 0, l = dynamicElements.length; i !== l; i++) {
            ...
            dynamicElements[i] = element
              .data("placeholder", $('<span style="display:none;"></span>'))
              .data("layout", "default");
          }
    ...
    $.extend(Plugin.prototype, {
      init: function () {
        (this.containerHeight = this.$element.outerHeight()),
          (this.$containerPlaceHolder = $("<div></div>").addClass(
  ...
  (function ($, window) {
    ...
    $.extend(Plugin.prototype, {
      ...
      _initPagination: function () {
        (this.$pagination = $("<nav></nav>").addClass(
      ...
      _updatePagination: function (currentPage, totalPage, items) {
        if (this._internalPaginate) this._internalPaginate = !1;
          ...
          if (1 < totalPage) {
            html +=
              '<li class="prev"><a href="#" data-prev="true">Previous</a></li>';
            ...
            html +=
              '<li class="next"><a href="#" data-next="true">Next</a></li>';
          }
      ...
      _onCarouselInit: function () {
        ...
        this.$element
          ...
          (st.arrows || (st.bullets && st.wrapControls)) &&
            (this.$controlsWrap = $("<div></div>")
              .addClass(st.controlsClass)
              .insertAfter(this.$element)),
          st.arrows &&
            ((this.$prevArrow = $("<div></div>")
  ...
  (function ($, window) {
    ...
    function Plugin(element, options) {
      (this.element = element),
        ...
        (this.settings = $.extend({}, defaults, options)),
        (this._defaults = defaults),
        (this._name = "AuxinToggleSelected"),
        this.init();
    }
    $.extend(Plugin.prototype, {
      init: function () {
        (this.$targets = this.$element.find(this.settings.target)),
          this.$targets.on(
            this.settings.event,
            this._toggleSelected.bind(this)
          ),
          this.$element.hasClass(this.settings.overlayClass) &&
            ((this.overlay = this.$element.find(
              "." + this.settings.overlay
            )[0]),
            $(window).on("resize", this._locateOverlay.bind(this))),
          0 === this.$element.find("." + this.settings.selected).length &&
      ...
      _locateOverlay: function () {
        this.overlay &&
          this.$current &&
          ((this.overlay.style[window._jcsspfx + "Transform"] =
            "translate(" +
            (this.$current.offset().left - this.$element.offset().left) +
            "px, " +
            (this.$current.offset().top - this.$element.offset().top) +
            "px  )"),
          this.settings.resizeOverlay &&
            ((this.overlay.style.width = this.$current.outerWidth() - 1 + "px"),
            (this.overlay.style.height =
              this.$current.outerHeight() - 1 + "px")));
      },
      destroy: function () {
        ...
        (this.options = $.extend(
          ...
          this.$items.length &&
            (this.$items
              ...
              .wrap(
                '<div class="' + this.options.contentWrapClass + '"></div>'
              ),
        ...
        this.$element.removeClass(st.noJS),
          ...
          st.addSubIndicator &&
            (this.$menuItems
              ...
              .append('<span class="' + st.subIndicator + '"></span>'),
    ...
    $.extend(Plugin.prototype, {
      ...
      update: function (event) {
        var rect = this.element.getBoundingClientRect(),
          ...
          passedPageScroll = window.scrollY,
          areaTop = Math.min(
            this._parseOffset(this._offsetTop),
            passedPageScroll
          ),
          areaBottom =
            window.innerHeight -
            Math.min(
              this._parseOffset(this._offsetBottom),
              remainingPageScroll
            );
  ...
  (function ($, window) {
    ...
    (p.appendItem = function (item) {
      ...
      (p._updateView = function () {
        ...
        if (op.loop) {
          if (before - space < 2 * this[this._dimension])
            return (
              (op.loop = !1),
              (this.scroller.options.endless = !1),
      ...
      (p._gotoSnap = function (snapNum, animate, speed) {
        ...
        if ("perpage" === op.navigation || "scroll" === op.navigation)
          ...
          snapNum < 0
            ...
            scroller.changeTo(
              this.items[snapNum % this.itemsCount].position,
              animate,
              speed,
              snapNum
            );
          ...
          if (
            ...
            if (target && isFormMethodDialog(target.form)) {
              if (
                !(
                  "submit" === target.type &&
                  -1 < ["button", "input"].indexOf(target.localName)
                )
              ) {
