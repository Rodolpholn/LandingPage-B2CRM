...
document
  ...
  .forEach(function (element) {
    ...
    closestAnimElement &&
      [closestAnimElement, closestAnimElement.parentElement].forEach(function (
        animElement
      ) {
  ...
  (function ($, window) {
    ...
    "undefined" != typeof wp &&
      ...
      $__window.on("vc_reload", function () {
        if (
          (($vcWindow = $("#vc_inline-frame", window.parent.document)
            .contents()
            .find(".vc_element")),
          AuxinInitAllModules($vcWindow),
          "undefined" != typeof MediaElement &&
            $vcWindow.find("video,audio").mediaelementplayer(),
          "undefined" != typeof sbi_js_exists && sbi_init(),
          "undefined" != typeof fjgwpp_galleriesInit_functions)
        )
