((f, v, b, j) => {
  function t() {
    e && e.apply(this, arguments), (e = null);
  }
  var e;
  (j = f.extend(
    {
    ...
    (j.send_event = function (t) {
      if (
        ...
        var e =
          v[this.settings.data_layer] ||
          v[v.gtm4wp_datalayer_name] ||
          v.dataLayer;
        if ("object" == typeof e) {
          ...
          var n = this.settings.ga_event || "generate_lead",
            i = f.extend({ transport_type: "beacon" }, t),
            s =
              (f.each(i, function (t, e) {
                "page_location" == t
                  ? (i[t] = e.substring(0, 1e3))
                  : "page_referrer" == t
                  ? (i[t] = e.substring(0, 420))
                  : "page_title" == t
                  ? (i[t] = e.substring(0, 300))
                  : "string" == typeof e && (i[t] = e.substring(0, 100));
              }),
              []),
            a = function (t) {
              s.includes(t) ||
                ((t.startsWith("G-") || t.startsWith("GT-")) &&
                  (s.push(t), gtag("event", n, f.extend({ send_to: t }, i))));
            };
          if (
            v.google_tag_data &&
            google_tag_data.tidr &&
            google_tag_data.tidr.destination
          )
            for (var o in google_tag_data.tidr.destination) a(o);
        ...
        delete t.event_category,
          "object" == typeof e && e.push(f.extend({ event: h }, t)),
    ...
    (j.save_hash = function (t) {
      !this.settings.message_hash ||
        (this.settings.message_delay < 0 && !t) ||
        (-1 ===
          (t = (this.store.getItem("joinchat_hashes") || "")
            .split(",")
            .filter(Boolean)).indexOf(this.settings.message_hash) &&
    ...
    (j.open_whatsapp = function (t, e) {
      ...
      !1 !== f(b).triggerHandler("joinchat:open", [t]) &&
        (e.test(t.link)
          ? (this.send_event(t), v.open(t.link, "joinchat", "noopener"))
          : console.error(
    ...
    (e = function () {
      if (((j.$div = f(".joinchat")), j.$div.length)) {
        ...
        j.settings &&
          j.settings.telephone &&
          (j.is_mobile || !j.settings.mobile_only
            ? (f(b).trigger("joinchat:starting"),
              (n = 1e3 * j.settings.button_delay),
              (i = Math.max(0, 1e3 * j.settings.message_delay)),
              (s = !!j.settings.message_hash),
              (a = !!j.$(".joinchat__box").length),
              (o =
                parseInt(j.store.getItem("joinchat_views") || 1) >=
                j.settings.message_views),
              (l = (j.store.getItem("joinchat_hashes") || "")
                .split(",")
                .filter(Boolean)),
              (h =
                void 0 !== j.settings.is_viewed
                  ? j.settings.is_viewed
                  : -1 !== l.indexOf(j.settings.message_hash || "none")),
              ...
              j.$(".joinchat__button").on("click", function () {
                a && !j.chatbox
                  ? u()
                  : Date.now() > j.showed_at + 600 && (p(), j.open_whatsapp());
              }),
              ...
              j.is_mobile &&
                (f(b).on("focus blur", "input, textarea", function (t) {
                  f(t.target).closest(j.$div).length ||
                    (clearTimeout(c), (c = setTimeout(m, 200)));
                }),
                f(v)
                  .on("resize", function () {
                    clearTimeout(r),
                      (r = setTimeout(function () {
                        j.$div[0].style.setProperty(
                          "--vh",
                          v.innerHeight + "px"
                        );
                      }, 200));
                  ...
                  .trigger("resize")),
              "#joinchat" == (l = new URL(v.location)).hash &&
                (j.show(), setTimeout(u, 700)),
              l.searchParams.has("joinchat") &&
                ((n = 1e3 * (parseInt(l.searchParams.get("joinchat")) || 0)),
                setTimeout(function () {
                  j.show();
                }, n),
                setTimeout(u, 700 + n)),
              f(b).on(
                ...
                function (t) {
                  t.preventDefault(),
                    !a ||
                    (j.optin() &&
                      !f(this).is('.joinchat_open, a[href="#joinchat"]'))
                      ? j.open_whatsapp(
                          f(this).data("phone"),
                          f(this).data("message")
                        )
              ...
              f(b).on("click", ".joinchat_close", function (t) {
                t.preventDefault(), j.chatbox_hide();
              }),
              (l = f(".joinchat_show, .joinchat_force_show")),
              s &&
                l.length &&
                "IntersectionObserver" in v &&
                ((g = new IntersectionObserver(function (t) {
                  f.each(t, function () {
                    if (!(this.intersectionRatio <= 0)) {
                      var t = this.target.classList.contains(
                        "joinchat_force_show"
                      );
                      if (!h || t)
                        return g.disconnect(), j.save_hash(!t), u(), !1;
                    }
                  });
                })),
                l.each(function () {
              ...
              j.use_qr()
                ? j
                    .$(".joinchat__qr")
                    .append(j.qr(j.whatsapp_link(void 0, void 0, !1)))
                : j.$(".joinchat__qr").remove(),
              a &&
                j.$div.css(
                  "--peak",
                  "url(#joinchat__peak_" +
                    (j.$div.closest("[dir=rtl]").length ? "r" : "l") +
                    ")"
                ),
              i &&
                !o &&
                j.store.setItem(
                  "joinchat_views",
                  parseInt(j.store.getItem("joinchat_views") || 0) + 1
                ),
          ...
          j.can_qr && !j.is_mobile
            ? f(".joinchat-button__qr").each(function () {
                f(this).append(
                  j.qr(
                    j.whatsapp_link(
                      f(this).data("phone"),
          ...
          void 0 !== j.settings.sku) &&
          ((d = j.settings.message_send),
          f("form.variations_form").on(
      ...
      function u() {
        clearTimeout(e), j.chatbox_show();
      }
      function p() {
        j.save_hash(), j.chatbox_hide();
      }
      function m() {
